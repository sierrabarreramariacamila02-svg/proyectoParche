...
import {  obtenerUsuarioPorEmail, crearUsuarioGoogle, actualizarUsuario } from "../models/usuario.js";
...
export const autenticarConGoogle = async (req, res) => {
    try {
        ...
        const { data: usuarioExistente } = await  obtenerUsuarioPorEmail(email);
